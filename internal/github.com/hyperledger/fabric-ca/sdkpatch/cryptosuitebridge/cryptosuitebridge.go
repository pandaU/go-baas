...
import (
	...
	"baas-fabric/internal/github.com/hyperledger/fabric-ca/sdkpatch/keyutil"
	"baas-fabric/internal/github.com/hyperledger/fabric/bccsp"
	cspsigner "baas-fabric/internal/github.com/hyperledger/fabric/bccsp/signer"
...
// GetGMSM2PrivateKeyImportOpts returns options for ECDSA key generation.
func GetGMSM2PrivateKeyImportOpts(ephemeral bool) core.KeyGenOpts {
	return &bccsp.GMSM2PrivateKeyImportOpts{Temporary: ephemeral}
}

// GetGMSM2PublicKeyImportOpts returns options for ECDSA key generation.
func GetGMSM2PublicKeyImportOpts(ephemeral bool) core.KeyGenOpts {
